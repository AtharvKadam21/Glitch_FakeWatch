...
def classify_audio_clip(clip):
    ...
    state_dict = torch.load('predictor\models\classifier.pth', map_location=torch.device('cpu'))
...
def inspect_audio(url):
    ...
    # audio_res = 'The uploaded audio is ' + result + '% likely to be AI-generated'
    print(result)
    return result
